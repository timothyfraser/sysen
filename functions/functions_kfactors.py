# What this file is ----------------------------------------------------------
#
# The k-factor functions used in the textbook chapter on exponential
# distributions, for putting a confidence interval around an estimated
# failure rate: qk() for quantiles, pk() for cumulative probabilities, dk()
