# 13_examples.py
# Tim Fraser
# Factorial Design Examples for Practice
# Five factorial design experiments for participants to analyze
# using the functions from functions/functions_factorial.py
...
# Load the data
example1_plants = pd.read_csv("workshops/plants.csv")
...
# Load the data
example2_batteries = pd.read_csv("workshops/batteries.csv")
...
# Load the data
example3_website = pd.read_csv("workshops/website.csv")
...
# Load the data
example4_bikeshare = pd.read_csv("workshops/bikeshare.csv")
...
# Load the data
example5_drones = pd.read_csv("workshops/drones.csv")
...
# dbar_oneway(formula="flight_time ~ propeller", data=example5_drones)
# 4. Standard error: se_factorial...
# 5. Which effects are statistically significant? Remember that 1.96 standard errors is a good approximation of a 95% confidence interval.
...
#    By default, the low level is the level that comes alphabetically first.
#
